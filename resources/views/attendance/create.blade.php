                ...
                <div class="row">
                    <div class="col-md-12 pt-4">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="checkin_time" id="form4Example1" class="form-control timepicker" value="{{old('checkin_time')}}" />
                        </div>

                        <div class="form-group mb-4">
                            <label class="form-label" for="form4Example1">Checkout Time</label>
                            <input type="text" name="checkout_time" id="form4Example1" class="form-control timepicker" value="{{old('checkout_time')}}" />
                        </div>
                    </div>
                </div>
                <!-- Submit button -->
